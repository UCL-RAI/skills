...
Read `references/support-grades.md` when auditing a full section, defining issue types, or rewriting claims.
...
- Every non-obvious factual, historical, novelty, benchmark, or comparative claim has a support grade.
...
Done means every claim has a support grade and every weak or missing citation has a concrete fix path.
